...
config: config_data.config.Config = config_data.config.load_config()

print(config.pa_creds.pa_login)
print(config.pa_creds.pa_password)

pa_checker = PaClient(config.pa_creds.pa_login, config.pa_creds.pa_password,logger_level=logzero.DEBUG)
...
# print(verdict)
verdict = pa_checker.find_package("aiogram","3.1.1")
print(verdict)

verdict = pa_checker.find_package("logging")
print(verdict)
